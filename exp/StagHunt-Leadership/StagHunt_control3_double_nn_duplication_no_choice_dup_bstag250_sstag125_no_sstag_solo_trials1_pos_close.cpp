...
#define DOUBLE_NN
#define DUPLICATION
#define NO_CHOICE_DUP
#define BSTAG250
#define SSTAG125
#define NO_SSTAG_SOLO
#define TRIALS1
#define POS_CLOSE
...
#endif
    {
      ...
      for (size_t j = 0; j < Params::simu::nb_trials; ++j)
      {
      	...
      	// init
       	...
       	std::cout << "nbSStags 1 :" << h1->nb_small_stags_hunted() << std::endl;
       	std::cout << "nbSStags 2 :" << h2->nb_small_stags_hunted() << std::endl;
       	std::cout << "nbBStags 1 :" << h1->nb_big_stags_hunted() << std::endl;
       	std::cout << "nbBStags 2 :" << h2->nb_big_stags_hunted() << std::endl;
