...
struct Params
{
  struct simu
  {
    ...
    SFERES_STRING(map_name, "modules/fastsim_multi2/map800x800Wall.pbm");
...
int main(int argc, char *argv[])
{
  ...
  simu_t s(true);
	...
	Robot* r1 = new Robot(20.0f, Posture(250, 500, -M_PI/2), 2);  
  r1->use_camera();
...
/*	Robot* r2 = new Robot(20.0f, Posture(100, 100, -M_PI/2), 4, 2);  
  ...
  Map::ill_sw_t s1 = Map::ill_sw_t(new IlluminatedSwitch(200, 10, 200, 251, true));
  Map::ill_sw_t s2 = Map::ill_sw_t(new IlluminatedSwitch(300, 10, 530, 351, true));
